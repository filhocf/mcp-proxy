...
class TestAdminAPI:
    def _make_app(self, api_key=None, on_register=None, on_unregister=None):
        ...
        routes = create_admin_routes(
            ...
            on_register=on_register, on_unregister=on_unregister,
        )
    ...
    def test_register_server_no_auth(self):
    ...
    def test_register_server_with_auth(self):
        ...
        # With auth
        resp = client.post(
            "/servers", json={"name": "test", "command": "echo"},
    ...
    def test_register_missing_command(self):
        app, _ = self._make_app()
        client = TestClient(app)
    ...
    def test_unregister_with_auth(self):
